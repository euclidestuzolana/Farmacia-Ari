...
<div class="container">
    <div class="row">
        <form class="form-inline navbar-search" method="post" action="pesquisarprodHomeCre.php" >
            <input id="srchFld" class="srchTxt" type="text" name="pesquisar"/>
            <div class="btn-group" > <input type="text" value="Cremes"disabled>
        ...
        $result_usuarios = "SELECT id,imagem,nome,farmacias,categoria,qnt_voto,preco FROM produtos,farmacia,categoriaprod WHERE farmaciaprod=idfarmacia and categoriaprod=idcategoria and  farmaciaprod='1' and categoriaprod='20' LIMIT  $inicio, $qnt_result_pg ";
...
$result_pg = "SELECT COUNT(id) AS num_result FROM produtos WHERE farmaciaprod='1' and categoriaprod='20'";
...
$max_links = 2;
echo "<a href='listarCre.php?pagina=1'><b class='btn btn-success'>Primeira</b></a>";

for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
    if($pag_ant >= 1){
        echo "<a href='listarCre.php?pagina=$pag_ant'>$pag_ant</a> ";
    }
}
...
for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
    if($pag_dep <= $quantidade_pg){
        echo "<a href='listarCre.php?pagina=$pag_dep'>$pag_dep</a> ";
    }
}

echo "<a href='listarCre.php?pagina=$quantidade_pg'><b class='btn btn-success'>Ultima</b></a>";
