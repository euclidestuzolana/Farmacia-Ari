...
<div class="container">
    <div class="row">
        ...
        $result_usuarios = "SELECT id,imagem,nome,farmacias,categoria,qnt_voto,preco FROM produtos,farmacia,categoriaprod WHERE farmaciaprod=idfarmacia and categoriaprod=idcategoria and  farmaciaprod='1' LIMIT  $inicio, $qnt_result_pg ";
...
$result_pg = "SELECT COUNT(id) AS num_result FROM produtos WHERE farmaciaprod='1'";
...
$max_links = 2;
echo "<a href='listar.php?pagina=1'><b class='btn btn-success'>Primeira</b></a>";
...
echo "<a href='listar.php?pagina=$quantidade_pg'><b class='btn btn-success'>Ultima</b></a>";
